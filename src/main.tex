...
\begin{table}[htbp]
  ...
  \begin{center}
      \begin{tabular}{|c|c|}
          \hline
          \textbf{CPU} & \multicolumn{1}{|c|}{\textbf{Valores}} \\
          %\cline{2-4} 
          %\textbf{} & \textbf{\textit{Table column subhead}}& \textbf{\textit{Subhead}}& \textbf{\textit{Subhead}} \\
          \hline
          Tamanho da Linha & More table copy \\
          \hline
          Ciclos por leitura & More table copy \\
          \hline
          Ciclos por escrita & More table copy \\
          \hline
          Tempo de ciclo & More table copy \\
          \hline
          Tamano da Mémoria & More table copy \\
          \hline
          Associatividade & More table copy \\
          \hline
          MemorySize & More table copy \\
          \hline
          Politica de Substituição & More table copy \\
          \hline
